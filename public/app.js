...
async function sendGifUrl() {
  ...
  sendGifBtn.disabled = true;

  showToast("Mengirim GIF...");
  ...
  try {
    ...
    data.message.url = selectedGifUrl;
...
function validateGifUrl() {
  ...
  gifPreview.innerHTML =
    ...
    "document.getElementById('sendGifBtn').disabled = true; " +
    "document.querySelector('#toast').textContent = 'GIF tidak ditemukan atau gagal dimuat'; " +
    "document.querySelector('#toast').classList.add('show'); " +
    'setTimeout(() => document.querySelector("#toast").classList.remove("show"), 2200)' +
    '" onload="' +
    "document.getElementById('sendGifBtn').disabled = false;" +
    '">';
...
closeGifModal.addEventListener(
  "click",
  closeGifModalHandler
);

cancelGifBtn.addEventListener(
  "click",
  closeGifModalHandler
);

sendGifBtn.addEventListener(
  "click",
  sendGifUrl
);
